    ...
    options: {
      ...
      scales: {
        ...
        y: {
          ...
          // Для да-нет графиков: от -0.2 до 1.2 (чтобы не обрезалось)
          min: ['morning', 'workouts', 'abs'].includes(metricKey) ? -0.2 : metricKey === 'water' ? 0 : undefined,
          max: ['morning', 'workouts', 'abs'].includes(metricKey) ? 1.2 : metricKey === 'water' ? 6 : undefined,
          ticks: {
