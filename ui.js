    ...
    options: {
      ...
      scales: {
        ...
        y: {
          ...
          min: ['morning', 'workouts', 'abs'].includes(metricKey) ? 0 : undefined,
          max: ['morning', 'workouts', 'abs'].includes(metricKey) ? 1 : undefined,
          ticks: {
            stepSize: ['morning', 'workouts', 'abs'].includes(metricKey) ? 1 : undefined,
